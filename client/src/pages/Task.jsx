        ...
        <form className="m-auto my-16 max-w-[1000px] bg-white p-8 border-2 shadow-md rounded-md">
          {loading ? (
            ...
            <>
              ...
              <button
                className="bg-primary text-white px-4 py-2 font-medium hover:bg-primary-dark rounded-md"
              ...
              {mode === "update" && (
                <button
                  className="ml-4 bg-emerald-600 text-white px-4 py-2 font-medium hover:bg-emerald-700 rounded-md"
                  onClick={handleReset}
                >
                  Reset
                </button>
