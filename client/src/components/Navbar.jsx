...
const Navbar = () => {
  ...
  return (
    <>
      <header className="flex justify-between sticky top-0 p-4 bg-zinc-800 shadow-sm items-center">
        <h2 className="cursor-pointer uppercase font-medium text-white">
          <Link to="/">
            {" "}
            WorkFlow <span className="text-emerald-400">Wizard</span>{" "}
          </Link>
        </h2>
        <ul className="hidden md:flex gap-4 uppercase font-medium">
          {authState.isLoggedIn ? (
            <>
              <li className="bg-emerald-600 text-white hover:bg-emerald-700 font-medium rounded-md">
              ...
              <li
                className="py-2 px-3 cursor-pointer text-white hover:bg-gray-200 hover:text-black transition rounded-sm"
        ...
        <span className="md:hidden cursor-pointer text-white" onClick={toggleNavbar}>
        ...
        >
          ...
          <ul className="flex flex-col gap-4 uppercase font-medium text-center">
            {authState.isLoggedIn ? (
              <>
                <li className="bg-emerald-600 text-white hover:bg-emerald-700 font-medium transition py-2 px-3">
