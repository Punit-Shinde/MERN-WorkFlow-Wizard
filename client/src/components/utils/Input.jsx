...
export const Select = ({ id, name, value, options, className = "", placeholder, onChange }) => {
  return (
    <select id={id} name={name} value={value} className={`block w-full mt-2 px-3 py-2 text-gray-600 rounded-[4px] border-2 border-gray-100 focus:border-primary transition outline-none hover:border-gray-300 ${className}`} onChange={onChange}>
